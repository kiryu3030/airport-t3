class stepperCMD {
  ...
  constructor(id, mode, pulse, runTime, angle, addRunTime = true) {
    ...
    this.cmd = Buffer.allocUnsafe(18);
    this.cmd.writeUint8(id, 0); //1
    this.cmd.writeUint8(0xCD, 1); //1 fc
    this.cmd.writeUint8(0x00, 2); //1
    this.cmd.writeUint16BE(this.accrpm, 3); //2 acc
    this.cmd.writeUint16BE(this.accrpm, 5); //2 dec
    this.cmd.writeUint16BE(this.rpm*10, 7); //2 speed
    this.cmd.writeUInt32BE(this.angle*10, 9); //4 angle
    this.cmd.writeUint8(this.mode, 13); //1
    this.cmd.writeUint8(0x00, 14); //1
    this.cmd.writeUint16BE(3000, 15); //2
    this.cmd.writeUint8(0x6B, 17); //1
